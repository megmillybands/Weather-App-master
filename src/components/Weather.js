...
function Weather() {
  ...
  const getAlertTypeFromWeather = (weatherData) => {
    ...
    if (description.includes("sleet") || description.includes("hail"))
  ...
  const updateBackground = (weatherMain) => {
    ...
    switch (weatherMain.toLowerCase()) {
      ...
      case "clouds":
        gradient =
          "linear-gradient(-45deg, #bdc3c7, #2c3e50, #757f9a, #d7dde8)";
        break;
      case "rain":
        gradient =
          "linear-gradient(-45deg, #4e54c8, #8f94fb, #667db6, #0082c8)";
        break;
      case "thunderstorm":
        gradient =
      ...
      case "snow":
        gradient =
          "linear-gradient(-45deg, #e0eafc, #cfdef3, #f8fbff, #e2ebf0)";
        break;
      case "drizzle":
        gradient =
      ...
      case "fog":
        gradient =
          "linear-gradient(-45deg, #757f9a, #d7dde8, #bdc3c7, #2c3e50)";
        break;
      case "haze":
        gradient =
          "linear-gradient(-45deg, #ffecd2, #fcb69f, #f6d365, #fda085)";
        break;
      case "smoke":
        gradient =
          "linear-gradient(-45deg, #434343, #000000, #232526, #414345)";
        break;
      case "dust":
      case "sand":
        gradient =
          "linear-gradient(-45deg, #eacda3, #d6ae7b, #cbb4d4, #20002c)";
        break;
      default:
        gradient =
          "linear-gradient(-45deg, #89f7fe, #66a6ff, #a1c4fd, #c2e9fb)";
